...
COPY maven/dependency-check-scan-template-script.sh $DC_PROJECTS_TO_SCAN_DIRECTORY/Petclinic
...
COPY gradle/dependency-check-scan-template-script.sh $DC_PROJECTS_TO_SCAN_DIRECTORY/vulnerable-java-application
